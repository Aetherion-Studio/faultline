...
const kofiWidgetOverlayConfig = {
    ...
    'floating-chat.core.position.bottom-left': 'position: fixed; bottom: 50px; right: 10px; left: auto; width: 160px; height: 65px;',
    ...
    function createButtonContainerIframe(iframeId, mainStyleSheetFile) {
        ...
        var _timer = setInterval(function () {
            ...
            if (doc && doc.readyState == 'complete') {
                ...
                parentWrapper.style = 'z-index:10000; position:fixed; bottom:50px; right:10px; left:auto;';
                mobiParentWrapper.style = 'z-index:10000; position:fixed; bottom:50px; right:10px; left:auto;';
...
function attachDonateButton(iframeContainerElement, iframeId, selectors, heightLimits) {
    ...
    donateButton.addEventListener('click',
        function () {
            window.open('https://ko-fi.com/faultlineglobal', '_blank');
        });
    ...
    function slidePopupOpen(popup, finalHeight) {
        popup.style = `z-index:10000;width:328px!important;height: ${finalHeight}px!important; transition: height 0.5s ease, opacity 0.3s linear; opacity:1; position:fixed; bottom:120px; right:10px; left:auto;`;
